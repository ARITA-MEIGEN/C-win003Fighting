...
private:
	template<class Ty>
	static inline Ty ToRadian(const Ty angle)
	{
		return static_cast<Ty>(angle * Pai<Ty> / _180<Ty>);
	}

	template<class Ty>
	static inline bool AdjEqual(const Ty epsilon_num, const Ty num)
	{
...
public:
	...
	static inline Ty InQuad(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty OutQuad(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty InOutQuad(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty InCubic(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty OutCubic(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
	...
	template<class Ty = float>
	static inline Ty InOutCubic(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty InQuart(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty OutQuart(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time = time / totaltime - _1<Ty>;
	...
	template<class Ty = float>
	static inline Ty InOutQuart(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty InQuint(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty OutQuint(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time = time / totaltime - _1<Ty>;
	...
	template<class Ty = float>
	static inline Ty InOutQuint(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	//現在の時間,全体フレーム,最終的な値,開始の値
	static inline Ty InSine(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;

		return -max * std::cos(time * ToRadian<Ty>(_90<Ty>) / totaltime) + max + min;
	}

	template<class Ty = float>
	static inline Ty OutSine(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
	...
	template<class Ty = float>
	static inline Ty InOutSine(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
	...
	template<class Ty = float>
	static inline Ty InExp(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
	...
	template<class Ty = float>
	static inline Ty OutExp(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
	...
	template<class Ty = float>
	static inline Ty InOutExp(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
	...
	template<class Ty = float>
	static inline Ty InCirc(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty OutCirc(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
	...
	template<class Ty = float>
	static inline Ty InOutCirc(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
		time = (std::max)((std::min)(time, _1<Ty>), -_1<Ty>);
	...
	template<class Ty = float>
	static inline Ty InBack(Ty time, Ty totaltime, Ty back, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty OutBack(Ty time, Ty totaltime, Ty back, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time = time / totaltime - _1<Ty>;
	...
	template<class Ty = float>
	static inline Ty InOutBack(Ty time, Ty totaltime, Ty back, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		back *= _1_525<Ty>;
	...
	template<class Ty = float>
	static inline Ty OutBounce(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		max -= min;
		time /= totaltime;
	...
	template<class Ty = float>
	static inline Ty InBounce(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
		return max - OutBounce<Ty>(totaltime - time, totaltime, max - min, _0<Ty>) + min;
	}

	template<class Ty = float>
	static inline Ty InOutBounce(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
	...
	template<class Ty = float>
	static inline Ty Linear(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
	{
